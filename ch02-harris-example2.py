# -*- coding: utf-8 -*-
"""
Created on Fri Apr 06 01:09:42 2018
...
matches = match_twosided(d1,d2)                       # Two-sided symmetric version of match(). match(), for each corner point descriptor in the first image, select its match to second image using normalized cross-correlation.
